$(document).ready(function (){	
	...
	$(".downlist").hover(
		function(){
			$(this).children(".down-nav").fadeIn("slow");
		},
		function(){
			//$(this).children("span").fadeIn();
			$(this).children(".down-nav").stop().fadeOut();				
		}
	...
	$(".feature-container .feature-nav a").click(function(){
		
		$(".feature-container .feature-nav a").removeClass("active");
		$(".feature-container .community-club").hide();
