    ...
    this._init = function(iTimeLeft,iScore,iShots,refGame){        
        ...
        createjs.Tween.get(_oTextSuccessPerc)
            ...
            .call(function(){
                    ...
                    _oButReplay = new CTextButton(CANVAS_WIDTH/2,CANVAS_HEIGHT/2 + 105,oSprite,TEXT_HOME,"impactregular","#ffffff",30,s_oStage);
                    _oButReplay.addEventListener(ON_MOUSE_UP, that._onButHome, that);
