function CPreloader(){
    ...
    this._init = function(){
       ...
       s_oSpriteLibrary.addSprite("bg_preloader",base_url+"assets/frontend/js/game/basketball/sprites/bg_preloader.jpg");
       s_oSpriteLibrary.addSprite("progress_bar",base_url+"assets/frontend/js/game/basketball/sprites/progress_bar.png");
       s_oSpriteLibrary.addSprite("preloader_anim",base_url+"assets/frontend/js/game/basketball/sprites/preloader_anim.png");
