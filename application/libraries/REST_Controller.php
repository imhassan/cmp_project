...
abstract class REST_Controller extends CI_Controller {
    ...
    {
        log_message('trace','API:: _check_cors call 1');
        ...
        {
            log_message('trace','API:: _check_cors call 2 with method '.$this->input->method());
        ...
        {
            log_message('trace','API:: _check_cors call 3');
        ...
        {
            log_message('trace','API:: _check_cors call 4');
            exit;
        }
    }
}
